...
unsigned int* dense_0_block_nz_begin_offset;
unsigned long size_of_dense_0_block_nz_begin_offset = 72;

unsigned char* dense_0_thread_block_size_in_block;
unsigned long size_of_dense_0_thread_block_size_in_block = 72;


float* dense_0_val_arr;
unsigned long size_of_dense_0_val_arr = 205440;

unsigned short* dense_0_col_index_arr;
unsigned long size_of_dense_0_col_index_arr = 205440;
...
template_data->dense_0_block_nz_begin_offset = (unsigned int *)read_arr_from_file_with_data_type(template_data->size_of_dense_0_block_nz_begin_offset, UNSIGNED_INT, file_name_prefix + "/block_nz_begin_offset");
template_data->dense_0_thread_block_size_in_block = (unsigned char *)read_arr_from_file_with_data_type(template_data->size_of_dense_0_thread_block_size_in_block, UNSIGNED_CHAR, file_name_prefix + "/thread_block_size_in_block");
...
template_data->dense_0_col_index_arr = (unsigned short *)read_arr_from_file_with_data_type(template_data->size_of_dense_0_col_index_arr, UNSIGNED_SHORT, file_name_prefix + "/col_index_arr");
