...
{
unsigned int* dense_0_global_first_row_index_of_warp_level_block;
unsigned long size_of_dense_0_global_first_row_index_of_warp_level_block = 169314;

unsigned short* dense_0_combine_meta_of_thread_level_block;
unsigned long size_of_dense_0_combine_meta_of_thread_level_block = 5418048;


float* dense_0_val_arr;
unsigned long size_of_dense_0_val_arr = 27090240;

unsigned int* dense_0_col_index_arr;
unsigned long size_of_dense_0_col_index_arr = 27090240;
...
template_data->dense_0_global_first_row_index_of_warp_level_block = (unsigned int *)read_arr_from_file_with_data_type(template_data->size_of_dense_0_global_first_row_index_of_warp_level_block, UNSIGNED_INT, file_name_prefix + "/global_first_row_index_of_warp_level_block");

template_data->dense_0_combine_meta_of_thread_level_block = (unsigned short *)read_arr_from_file_with_data_type(template_data->size_of_dense_0_combine_meta_of_thread_level_block, UNSIGNED_SHORT, file_name_prefix + "/combine_meta_of_thread_level_block");
