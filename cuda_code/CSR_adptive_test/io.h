...
// 列号和行偏移
unsigned int *col_idx = NULL;
unsigned int *row_off = NULL;
unsigned int *block_first_row_index = NULL;
float *values = NULL;
...
unsigned int div_row_into_block(unsigned int *row_begin_off, unsigned int row_num)
{
	...
	block_first_row_index = new unsigned int[size_of_block_first_row_index];
...
void coo2csr(unsigned int row_length, unsigned int nnz, float *values, unsigned int *row, unsigned int *col,
