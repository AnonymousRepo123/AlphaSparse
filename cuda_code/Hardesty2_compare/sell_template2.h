...
unsigned long size_of_dense_0_block_nz_begin_offset = 1824;

unsigned char* dense_0_thread_block_size_in_block;
unsigned long size_of_dense_0_thread_block_size_in_block = 1824;


double* dense_0_val_arr;
unsigned long size_of_dense_0_val_arr = 4027904;

unsigned int* dense_0_col_index_arr;
unsigned long size_of_dense_0_col_index_arr = 4027904;
...
template_data->dense_0_val_arr = (double *)read_arr_from_file_with_data_type(template_data->size_of_dense_0_val_arr, DOUBLE, file_name_prefix + "/val_arr");
